...
function Navbar({ className }) {
  ...
  return (
    ...
    >
      <nav className="flex items-center rounded-full dark:border-white/[0.2] justify-between px-6 py-2 bg-white dark:bg-white">
          ...
          <div className="group relative">
            ...
            {token && (
              <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
                <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-gray-500 text-black rounded-md">
